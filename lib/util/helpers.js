...
// Gate trinket creation/forking: user must be approved (instructor, student, or admin).
// Admins are identified by the site 'admin' role (seeded from the admin-email allowlist at login).
...
// controllers without throwing. Restricts course create/copy to admins (site 'admin' role) and
// approved instructors (user.isInstructor). Students, including those with elevated per-course
// roles, cannot create or copy.
