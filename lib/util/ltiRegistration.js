...
function buildToolConfiguration() {
  var base = config.url;
  // LMS tool icon = the Trinket logomark. The LMS tile should identify the TOOL ("Trinket"),
  // not the per-deploy brand (that lives inside the app). This asset is tracked + served (200);
  // the bare /img/logo.png is gitignored out of the slim Cloud Run image (404 -> broken icon).
