...
function buildToolConfiguration() {
  var base = config.url;
  // Advertise the per-deploy brand logo (force-included in the deploy image + served);
  // the bare /img/logo.png is gitignored out of the slim Cloud Run image (404 -> broken LMS icon).
  var logo = base + (config.app.logo || '/img/logo.png');
  var doc = {
