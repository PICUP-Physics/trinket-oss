...
function checkSnapshot(trinket) {
  ...
  if (!self.snapshot) {
    // The default thumbnail is a static asset shipped with the app, not a
    // user-generated snapshot, so serve it from /img rather than the object
    // store (where it was never uploaded and would 404).
