var config = require('config'),
    ...
    normalizeEmbedUrls = require('../util/material-parser').normalizeEmbedUrls,
...
module.exports = {
  ...
  getMaterial : function(request, reply) {
    ...
    return promise.then(function(trinket) {
      ...
      if (data.content) {
        data.content = normalizeEmbedUrls(data.content, request.info.hostname);
      }
              ...
              return Promise.resolve(LtiPlatform.findById(link.platformId))
                .then(function(platform) {
                  ...
                  return Promise.resolve(LtiUserIdentity.findByUsersAndIss(userIds, platform.issuer))
                    ...
                    .catch(function() { return request.success({ data: submissions }); });
                })
                .catch(function() { return request.success({ data: submissions }); });
            })
            .catch(function() { return request.success({ data: submissions }); });
