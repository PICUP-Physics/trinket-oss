    ...
    return getUserId()
      ...
      .then(function(trinkets) {
        ...
        trinkets = trinkets.map(function(t) {
          // Normalize to a plain object: on the mongoose backend these are
          // Documents, where assigning non-schema fields (totalViews, id,
          // lowerName...) is silently DROPPED at serialization. Firestore
          // docs' toObject() includes id/_id already.
          if (typeof t.toObject === 'function') t = t.toObject();
          var m = t.metrics || {};
