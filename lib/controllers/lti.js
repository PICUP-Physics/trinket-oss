...
module.exports = {
  ...
  deepLinkPicker: function(request, reply) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      var anyAssignments = view.some(function (c) { return c.assignments.length > 0; });
      return request.success({ courses: view, anyAssignments: anyAssignments, returnConfigured: true });
    }).catch(function (e) {
