...
module.exports = {
  ...
  deepLinkPicker: function(request, reply) {
    ...
    // Context-aware picker: assignment_selection (accept_multiple:false) offers assignments;
    // link_selection (accept_multiple:true) offers the whole course + its topics (lessons).
    var contentMode = !!dl.acceptMultiple;
    return new Promise(function(resolve, reject) {
