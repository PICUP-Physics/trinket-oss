...
function rehostAsset(relativePath, user) {
  ...
  return new Promise(function(resolve) {
    request({ url: sourceUrl, encoding: null }, function(err, resp, body) {
      ...
      FileUtil._upload(body, container, true, fileinfo, function(uploadErr) {
        if (uploadErr) {
...
function rehostImportedAssets(content, user) {
...
function createMaterialFromFile(lesson, matFile, user) {
  ...
  return rehostImportedAssets(matFile.content, user).then(function(content) {
